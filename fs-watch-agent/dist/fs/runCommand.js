...
const runModify_1 = __importDefault(require("./runModify"));
...
function runStep(step) {
    try {
        ...
        switch (step.command.commandName) {
            ...
            case 'modify': {
                runModify_1.default(step.graph, step.command.toRelation(), step.output);
                return;
            }
            case 'delete': {
...
function runGetStep(step) {
    ...
    runSearch_1.default(step.graph, search);
    return;
}
