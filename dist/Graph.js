...
const ObjectSpace_1 = require("./hooks/ObjectSpace");
...
const hookObjectSpace_1 = require("./hooks/hookObjectSpace");
const Git_1 = __importDefault(require("./hooks/Git"));
const FileChangedLog_1 = __importDefault(require("./hooks/FileChangedLog"));
class Graph {
    constructor() {
        ...
        this.saveSearchHooks = [];
        this.storageSlotHooks = [];
        ...
        this.saveSearchHooks.push(hookObjectSpace_1.getObjectSpaceHooks());
        this.saveSearchHooks.push(new FileChangedLog_1.default(this));
        this.storageSlotHooks.push(Git_1.default(this));
    }
    savedQuery(queryStr) {
