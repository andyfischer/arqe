...
const _1 = require(".");
_1.test('listen works', async ({ set, listen }) => {
...
_1.test('listen works 2', async ({ set, listen }) => {
...
_1.test('listen works with increment', async ({ set, listen }) => {
    await set('a/1');
    const getResults = listen('a/*');
...
_1.test('listen works with multi increment', async ({ set, listen }) => {
