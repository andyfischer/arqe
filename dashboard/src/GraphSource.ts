...
set touchpoint/getCliInput query(get cli-input(\${name}) value/*)
...
set touchpoint/listCliInputs query(get \${tool} cli-input/* value)
set touchpoint/listCliInputs input var/tool type/string
...
set touchpoint/cliInputIsRequired query(get \${tool} cli-input/* required)
set touchpoint/cliInputIsRequired input var/tool type/string
...
set touchpoint/setCliInput query(set cli-input(\${name}) value/(set \${value}))
