...
set code-generation/watch-file destination-filename(src/WatchFileApi.ts)
...
set touchpoint/findWatch query(file-watch/* filename(\${filename}))
...
set touchpoint/listenToFile query(listen file-watch/\${watch} version/*)
